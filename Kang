...
finishlogo='
============================================================
	  云免流控™-Web流控系统  本系统由何以潇破解
		Powered by 何以潇QQ 1744744000  2017
			All Rights Reserved
...
function authentication() {
    ...
    then
		...
		echo -e '\033[33m		Powered by 何以潇QQ 1744744000 2017\033[0m'
		echo -e '\033[33m		All Rights Reserved \033[0m'
		echo -e '\033[33m	官方网址：http://www.juliwangluo.cn/ \033[0m'
		echo -e '\033[33m	大佬装逼交流群：541349340 欢迎你的加入！\033[0m'
		echo -e '\033[33m=========================================================\033[0m'
...
echo
echo -e '\033[33m请输入正版密钥开启安装向导（购买网址:\033[32m www.juliwangluo.cn \033[0m）'
echo
echo -e "\033[34m何以潇提示：授权码请随便输入~~~\033[0m"
echo
...
then
echo -e '\033[33m==========================================================================\033[0m'
echo -e '\033[34m               未能通过验证 请确认您的密钥是否正确！ 本系统由何以潇破解\033[0m'
...
echo -e '\033[33m               官方网址：http://www.juliwangluo.cn/\033[0m'
echo -e '\033[31m               大佬装逼交流群：541349340   	欢迎你的加入！\033[0m'
echo -e '\033[33m==========================================================================\033[0m'
exit 0;
else
if [[ "$kcard" == "yes" ]]
